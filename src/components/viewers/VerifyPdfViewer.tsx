                            ...
                            <div className="grid grid-cols-1 gap-3">
                                ...
                                <div className="flex items-end gap-2">
                                    <div className="flex-[2]">
                                        ...
                                        <select className="w-full border border-gray-300 rounded-lg px-3 py-2 text-[14px] focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-white" value={extractType} onChange={(e)=>setExtractType(e.target.value)}>
