...
const { documentSearchRoutes } = await import('./routes/document-search.js')
...
const { entitiesRoutes } = await import('./routes/entities.js')
const { llmRoutes } = await import('./routes/llm.js')
const { nerRoutes } = await import('./routes/ner.js')
...
await fastify.register(documentSearchRoutes, { prefix: '/api' })
console.log('✅ documentSearchRoutes registered')
...
await fastify.register(personsRoutes, { prefix: '/api' })
console.log('✅ personsRoutes registered')
await fastify.register(entitiesRoutes, { prefix: '/api' })
console.log('✅ entitiesRoutes registered')
await fastify.register(llmRoutes, { prefix: '/api' })
console.log('✅ llmRoutes registered')
await fastify.register(nerRoutes, { prefix: '/api' })
console.log('✅ nerRoutes registered')
